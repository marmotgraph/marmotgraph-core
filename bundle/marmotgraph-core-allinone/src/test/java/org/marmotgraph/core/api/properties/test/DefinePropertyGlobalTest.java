...
public class DefinePropertyGlobalTest extends AbstractTest {
    ...
    protected void setup() {
        ...
        instance = assureValidPayload(instances.createNewInstance(TestDataFactory.createTestData(smallPayload, 0, true), "functionalityTest", false, false, new ExtendedResponseConfiguration()));
