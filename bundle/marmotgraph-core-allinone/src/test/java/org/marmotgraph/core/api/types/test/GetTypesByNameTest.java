...
public class GetTypesByNameTest extends AbstractTest {
    ...
    @Override
    protected void run() {
         response = this.types.getTypesByName(Collections.singletonList(TestDataFactory.TEST_TYPE), ExposedStage.IN_PROGRESS, withProperties, false, spaceName == null ? null : spaceName.getName(), true);
    }
}
