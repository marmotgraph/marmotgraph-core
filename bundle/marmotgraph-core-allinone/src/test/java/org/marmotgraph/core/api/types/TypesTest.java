...
package org.marmotgraph.core.api.types;
...
import org.marmotgraph.core.api.types.test.GetTypesByNameTest;
import org.marmotgraph.core.api.types.test.GetTypesForInvitation;
import org.marmotgraph.core.api.types.test.GetTypesTest;
...
@TestPropertySource(properties = {"org.marmotgraph.core.metadata.synchronous=true"})
...
class TypesTest extends AbstractFunctionalityTest {
    ...
    void getTypesOk() {
        ...
        test.execute(() -> {
            ...
            Assertions.assertEquals(response.get(0).getIdentifier(), TestDataFactory.TEST_TYPE);
        });
    }
