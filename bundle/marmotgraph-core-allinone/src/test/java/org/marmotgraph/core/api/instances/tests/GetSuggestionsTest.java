...
import org.marmotgraph.commons.model.SuggestionResult;
...
public class GetSuggestionsTest extends AbstractInstanceTest {
    ...
    public ResultWithExecutionDetails<SuggestionResult> response;
    ...
    protected void run(){
        ...
        response = instances.getSuggestedLinksForProperty(originalInstance, ExposedStage.IN_PROGRESS, key, originalInstance.idAsUUID(), null, null, null, new PaginationParam());
    }
