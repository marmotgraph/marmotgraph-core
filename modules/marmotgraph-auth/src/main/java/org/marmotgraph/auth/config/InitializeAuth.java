...
package org.marmotgraph.auth.config;
...
public class InitializeAuth {
    ...
    public InitializeAuth(@Value("${org.marmotgraph.authentication.adminGroup}") String adminGroup, PermissionsService permissionsService) {
