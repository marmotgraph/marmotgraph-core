...
package org.marmotgraph.commons.utils;
...
public class IdUtils {
    ...
    /**
     * MarmotGraph stores the source documents originating from different users separately. We therefore generate new ids for these user-specific representations by calculating a new UUID based on the concatenation of the user id and the instance id.
     *
    ...
    /**
     * @return the UUID extracted from the given absolute id or null if the passed JsonLdId is not an internal id of the MarmotGraph.
     */
