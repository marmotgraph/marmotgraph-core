...
public class JsonLd {
    ...
    public JsonLd(JsonAdapter jsonAdapter) {
    ...
    public NormalizedJsonLd normalize(JsonLdDoc payload, boolean keepNullValues) {
        ...
        try {
            JsonArray expanded = com.apicatalog.jsonld.JsonLd.expand(JsonDocument.of(build)).get();
            JsonObject compacted = com.apicatalog.jsonld.JsonLd.compact(JsonDocument.of(expanded), EMPTY_DOCUMENT).get();
