...
package org.marmotgraph.core.api.config.advices;
...
/**
 * This controller advice provides shared parameters (such as {@link PaginationParam}) and translates exceptions into http status codes.
 */
