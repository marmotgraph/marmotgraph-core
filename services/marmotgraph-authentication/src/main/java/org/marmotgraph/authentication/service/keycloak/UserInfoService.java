...
public class UserInfoService {
    ...
    public List<String> getUserOrClientProfile(String token){
        ...
        return getRolesFromUserInfo(userInfo);
    }
    ...
    public List<String> getRolesFromUserInfo(Map<String, Object> userInfo) {
        ...
        final List<Permission> results = permissionsService.getAllRoleDefinitions();
        return results.stream().map(r -> {
            String role = r.getId();
            DynamicJson claims = jsonAdapter.fromJson(r.getClaims(), DynamicJson.class);
