...
import org.marmotgraph.graphdb.AbstractGraphTest;
...
import org.marmotgraph.test.GlobalSpecifications;
import org.marmotgraph.test.MarmotGraphEditor;
...
class TodoListProcessorTest extends AbstractGraphTest {
    ...
    void upsertTypeDefinitionForClient() {
        ...
        NormalizedJsonLd typeDefinition =  jsonAdapter.fromJson(MarmotGraphEditor.PERSON_TYPE_DEFINITION, NormalizedJsonLd.class);
    ...
    void upsertPropertyDefinitionForClient() {
        ...
        NormalizedJsonLd typeDefinition = jsonAdapter.fromJson(MarmotGraphEditor.GIVEN_NAME_PROPERTY_DEFINITION, NormalizedJsonLd.class);
    ...
    void upsertPropertyDefinitionInTypeForClient() {
        ...
        NormalizedJsonLd editorClient = jsonAdapter.fromJson(GlobalSpecifications.MARMOTGRAPH_EDITOR_CLIENT, NormalizedJsonLd.class);
        ArangoDocumentReference clientId = upsert(admin, editorClient, DataStage.IN_PROGRESS);
        NormalizedJsonLd typeDefinition = jsonAdapter.fromJson(MarmotGraphEditor.GIVEN_NAME_IN_PERSON_PROPERY_DEFINITION, NormalizedJsonLd.class);
