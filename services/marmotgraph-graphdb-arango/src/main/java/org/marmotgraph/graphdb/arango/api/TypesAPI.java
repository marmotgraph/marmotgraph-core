...
@Profile("arango")
@Component
public class TypesAPI implements GraphDBTypes.Client {
    ...
    public TypesAPI(AuthContext authContext, StructureRepository structureRepository, MetaDataController metaDataController, PermissionsController permissionsController, DocumentsRepository documents) {
