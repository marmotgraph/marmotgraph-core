...
import org.marmotgraph.commons.api.GraphDBTodoLists;
...
@Profile("arango")
@Component
public class TodoListsAPI implements GraphDBTodoLists.Client {

    private final Logger logger = LoggerFactory.getLogger(getClass());

    private final TodoListProcessor todoListProcessor;

    public TodoListsAPI(TodoListProcessor todoListProcessor) {
