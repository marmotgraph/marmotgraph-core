...
import org.marmotgraph.graphdb.arango.ArangoProfile;
import org.marmotgraph.graphdb.arango.instances.controller.*;
...
public class InstancesAPI implements GraphDBInstances.Client {
    ...
    private final TypesAPI types;

    public InstancesAPI(InstancesRepository instances, IncomingLinksRepository incomingLinks, QueriesRepository queries, DocumentsRepository documents, NeighborsRepository neighbors, SuggestionsRepository suggestions, ReleaseStatusRepository releaseStatus, AuthContext authContext, IdUtils idUtils, TypesAPI types) {
