...
public class SpacesAPI implements GraphDBSpaces.Client {
    ...
    public SpacesAPI(StructureRepository structureRepository, MetaDataController metaDataController, PermissionsController permissionsController, AuthContext authContext) {
