...
package org.marmotgraph.primaryStore.scope.api;
...
@AllArgsConstructor
@Component
public class ScopeAPI implements Scopes.Client {

    private final InstanceScopeService instanceScopeService;


    @Override
    public List<UUID> relatedInstancesByScope(List<UUID> ids) {
        return this.instanceScopeService.getRelatedIds(ids);
    }
